...
export const getDevicesWA = () => api.get('/whatsapp/devices')
export const addDeviceWAAuto = (data) => api.post('/whatsapp/devices/auto', data)
export const addDeviceWAManual = (data) => api.post('/whatsapp/devices/manual', data)
export const getDeviceWAQr = (id, params) => api.get(`/whatsapp/devices/${id}/qr`, { params })
